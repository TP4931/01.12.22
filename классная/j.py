...
#Дан номер урока (число от 1 до 10). Определи, когда заканчивается указанный урок.
#Выведи два целых числа: время окончания урока в часах и минутах.
x=int(input())
y=x*45+(x//2)*5+((x+1)//2-1)*15
print(y//60+9,y%60)